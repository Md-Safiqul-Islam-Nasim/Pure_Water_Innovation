...
<div class="bi-home-banner-section">
    ...
    <div class="bi-banner-content">
        <div class="container bi-banner-content-container">
            <!-- top logo -->
            <a href="">
                <svg class="mobile--logo" xmlns="http://www.w3.org/2000/svg" width="109" height="87"
                    viewBox="0 0 109 87" fill="none">
                    <path
            ...
            <div class="bi-banner-headings">
                ...
                <div class="bi-banner-btns">
                    <a href="{{route('company-information')}}" class="bi-banner-schedule-btn">
                        Start Appointment Scheduling
                    </a>
                    <a href="#" class="bi-banner-play-btn">
                        <span>Learn More</span>
                        <svg class="playbtnIndex" xmlns="http://www.w3.org/2000/svg" width="41" height="40"
                            ...
                            <path
                                ...
                                fill="#161C24" stroke="#161C24" stroke-width="1.5" stroke-miterlimit="10"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <defs>
                                <filter id="filter0_b_22044_389" x="-0.966675" y="-1.41666" width="42.8334"
                                    height="42.8333" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                    <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                    <feGaussianBlur in="BackgroundImageFix" stdDeviation="2" />
                                    <feComposite in2="SourceAlpha" operator="in"
                                        result="effect1_backgroundBlur_22044_389" />
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_22044_389"
                                        result="shape" />
                                </filter>
                            </defs>
                        </svg>
            ...
            <div class="common-card-gallery">
                ...
                <a href="shop.html">
                    <div class="bi-common-card">
                        <img src="frontend/images/private-use-1.png" alt="" srcset=""
    ...
    <div class="container bi-conmmon-container">
        <div class="bi-home-private-use-contents">
            ...
            <div class="common-card-gallery">
                <!-- card -->
                <div class="bi-common-card">
                    <img src="frontend/images/property-1.png" alt="" srcset=""
                        class="bi-common-card-img" />
                    <div class="bi-common-card-bottom">
                        <div class="bi-common-card-info">
                ...
                <!-- card  -->
                <div class="bi-common-card">
                    <img src="frontend/images/property-2.png" alt="" srcset=""
                        class="bi-common-card-img" />
                    <div class="bi-common-card-bottom">
                        <div class="bi-common-card-info">
                ...
                <!-- card  -->
                <div class="bi-common-card">
                    <img src="frontend/images/property-3.png" alt="" srcset=""
                        class="bi-common-card-img" />
                    <div class="bi-common-card-bottom">
                        <div class="bi-common-card-info">
                            <span class="bi-common-card-name">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" class="lines" width="1116" height="2" viewBox="0 0 1116 2"
            fill="none">
            <path d="M1 1H1115" stroke="#DFE3E8" stroke-width="2" stroke-linecap="round" />
        </svg>
    </div>
                    ...
                    <span class="round round_3">
                        <svg xmlns="http://www.w3.org/2000/svg" width="148" height="149" viewBox="0 0 148 149"
                            ...
                            <path
                                ...
                                stroke-linecap="round" stroke-linejoin="round" />
                            <defs>
                                <filter id="filter0_b_22096_377" x="7.39832" y="7.66675" width="132.833"
                                    height="133.667" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
                                    <feFlood flood-opacity="0" result="BackgroundImageFix" />
                                    <feGaussianBlur in="BackgroundImageFix" stdDeviation="2" />
                                    <feComposite in2="SourceAlpha" operator="in"
                                        result="effect1_backgroundBlur_22096_377" />
                                    <feBlend mode="normal" in="SourceGraphic" in2="effect1_backgroundBlur_22096_377"
                                        result="shape" />
                                </filter>
                            </defs>
                        </svg>
        ...
        <div class="bi-febrication-information">
            ...
            <ul class="bi-febrication-lists">
                <li class="bi-febrication-list">
                    <svg class="rightTik" xmlns="http://www.w3.org/2000/svg" width="25" height="24"
