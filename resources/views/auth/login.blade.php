                    ...
                    <div class="nr--signIn--inputBox">
                                    ...
                                    <div class="log--in--with--google--svg">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            ...
                                            <g clip-path="url(#clip0_5982_5140)">
                                                <mask id="mask0_5982_5140" style="mask-type:luminance"
                                                    maskUnits="userSpaceOnUse" x="4" y="3" width="16" height="17">
                                                    <path
                                                ...
                                                <g mask="url(#mask0_5982_5140)">
                                                    <path d="M3.4375 16.6317V7.14844L9.64755 11.8901L3.4375 16.6317Z"
                                                        fill="#FBBC05" />
                                                </g>
                                                <mask id="mask1_5982_5140" style="mask-type:luminance"
                                                    maskUnits="userSpaceOnUse" x="4" y="3" width="16" height="17">
                                                    <path
                                                        d="M19.6892 10.4316H12.2006V13.5319H16.5111C16.1093 15.5015 14.4289 16.6322 12.2006 16.6322C9.57046 16.6322 7.45173 14.5167 7.45173 11.8905C7.45173 9.26439 9.57046 7.14889 12.2006 7.14889C13.333 7.14889 14.3558 7.55011 15.1595 8.20665L17.4974 5.87229C16.0727 4.63217 14.2463 3.86621 12.2006 3.86621C7.74397 3.86621 4.16406 7.44068 4.16406 11.8905C4.16406 16.3404 7.74397 19.9148 12.2006 19.9148C16.2189 19.9148 19.8718 16.9969 19.8718 11.8905C19.8718 11.4164 19.7988 10.9057 19.6892 10.4316Z"
                                                        fill="white" />
                                                ...
                                                <mask id="mask2_5982_5140" style="mask-type:luminance"
                                                    maskUnits="userSpaceOnUse" x="4" y="3" width="16" height="17">
                                                    <path
                                                        d="M19.6892 10.4316H12.2006V13.5319H16.5111C16.1093 15.5015 14.4289 16.6322 12.2006 16.6322C9.57046 16.6322 7.45173 14.5167 7.45173 11.8905C7.45173 9.26439 9.57046 7.14889 12.2006 7.14889C13.333 7.14889 14.3558 7.55011 15.1595 8.20665L17.4974 5.87229C16.0727 4.63217 14.2463 3.86621 12.2006 3.86621C7.74397 3.86621 4.16406 7.44068 4.16406 11.8905C4.16406 16.3404 7.74397 19.9148 12.2006 19.9148C16.2189 19.9148 19.8718 16.9969 19.8718 11.8905C19.8718 11.4164 19.7988 10.9057 19.6892 10.4316Z"
                                                        fill="white" />
                                                ...
                                                <mask id="mask3_5982_5140" style="mask-type:luminance"
                                                    maskUnits="userSpaceOnUse" x="4" y="3" width="16" height="17">
                                                    <path
                                                        d="M19.6892 10.4316H12.2006V13.5319H16.5111C16.1093 15.5015 14.4289 16.6322 12.2006 16.6322C9.57046 16.6322 7.45173 14.5167 7.45173 11.8905C7.45173 9.26439 9.57046 7.14889 12.2006 7.14889C13.333 7.14889 14.3558 7.55011 15.1595 8.20665L17.4974 5.87229C16.0727 4.63217 14.2463 3.86621 12.2006 3.86621C7.74397 3.86621 4.16406 7.44068 4.16406 11.8905C4.16406 16.3404 7.74397 19.9148 12.2006 19.9148C16.2189 19.9148 19.8718 16.9969 19.8718 11.8905C19.8718 11.4164 19.7988 10.9057 19.6892 10.4316Z"
                                                        fill="white" />
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="nr--sign--in--checkbox">
                                ...
                                <label for="privecy"> <span class="nr--LogIn--with--commonText">Remember this</span>
                                </label>
                            </div>
                        ...
                        <div class="nr--dont--account">
                            <a class="nr--dont--account--text" href=" {{ route('register') }}">Don’t have an account!
                                <span>Sign Up</span></a>
                        </div>
                    </div>
