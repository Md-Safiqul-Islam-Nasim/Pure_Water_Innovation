                ...
                <div class="nr--signIn--right">
                    ...
                    <div class="nr--signIn--inputBox">
                            ...
                            <div class="nr--email--and--password--wrapper">
                                <div class="nr--email--input--main">
                                    ...
                                    <div class="nr--email--input">
                                        <input type="email" id="Forgetemail" name="email" placeholder="Enter Your Email"
                                            required>
                                    </div>
                                </div>
                            </div>

                            <div class="nr--reset--password--btn" style="margin-top: 5%; text-align: right;">
                        ...
                        <div class="nr--dont--account">
                            <a class="nr--dont--account--text" href="{{ route('login') }}">Don’t have an account! <span>Sign
                                    Up</span></a>
                        </div>
                    </div>
