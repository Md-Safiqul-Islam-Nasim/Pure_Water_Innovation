...
@section('content')
    {{-- ========== Title Wrapper Start ========== --}}
    <div class="container">
        <div class="py-4 mb-4 title-wrapper pt-30 s">
        ...
        <div class="form-layout-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-4 rounded shadow-sm card-style">
                        <form method="POST" action="{{ route('system.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" placeholder="Enter System Name" id="system_name"
                                        name="system_name" class="form-control @error('system_name') is-invalid @enderror"
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" placeholder="Enter Copyright Text" id="copyright_text"
                                        name="copyright_text"
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="file"
                                        class="form-control dropify @error('favicon') is-invalid @enderror" name="favicon"
                                        id="favicon"
                            ...
                            <div class="d-flex justify-content-between">
                                <button type="submit" class="px-4 py-2 btn btn-primary">Save Changes</button>
                                <a href="{{ route('dashboard') }}" class="px-4 py-2 btn btn-outline-danger">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
